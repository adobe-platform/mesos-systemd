...
etcdctl set /images/chronos      "mesosphere/chronos:chronos-2.4.0-0.1.20151007110204.ubuntu1404-mesos-0.26.0-0.2.145.ubuntu1404"
etcdctl set /images/fd           "behance/flight-director:latest"
etcdctl set /images/hud          "behance/flight-director-hud:latest"
etcdctl set /images/marathon     "mesosphere/marathon:v0.15.0"
etcdctl set /images/mesos-master "mesosphere/mesos-master:0.26.0-0.2.145.ubuntu1404"
